...
class CountriesDisaggregation {
  @ApiProperty({
    ...
    default: 'ISO 3166-1 alpha-2 code',
  })
  country_iso: string;
...
class StatisticsObject {
  ...
  downloads: number;
  @ApiProperty({
    type: [CountriesDisaggregation],
    description: 'Statistics aggregated by country',
  })
  country: CountriesDisaggregation;
  @ApiProperty({
    type: [CitiesDisaggregation],
    description: 'Statistics aggregated by city',
  })
  city: CitiesDisaggregation;
  @ApiProperty({
    type: [MonthsDisaggregation],
